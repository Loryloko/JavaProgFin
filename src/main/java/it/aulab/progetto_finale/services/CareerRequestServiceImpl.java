...
public class CareerRequestServiceImpl implements CareerRequestService {
    ...
    public void save(CareerRequest careerRequest, User user) {
        ...
        emailService.sendSimpleEmail("adminAulabpost@admin.com", "Nuova richiesta di carriera" + careerRequest.getRole().getName(), "C'è una nuova richiesta di carriera da parte di " + user.getUsername());
    }
    ...
    public void careerAccept(Long requestId) {
        ...
        emailService.sendSimpleEmail(user.getEmail(), "Ruolo accettato", "Ciao, la tua richiesta di collaborazione è stata accettata dalla nostra amministrazione");    
    }
